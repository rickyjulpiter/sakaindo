                ...
                <div class="col-md-9" style="margin-top:15px">
                    <div class="row">
                        <div class="col-md-12 center">
                            <h2 class="judulTeks" style="border-radius: 20px 20px 0px 0px;background-color: #c3c3c3;padding-top: 15px;padding-bottom: 15px;">Hubungi Kami</h2>
                            <div class="container" id="rcorners5" style="border-radius: 0px 0px 20px 20px;height:121vh; margin: -31px 0px 0px 0px">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <form style="font-size: 0.9rem;">
                                            ...
                                            <div class="form-group" style="text-align:left;">
                                                <label>Pesan</label>
                                                <textarea class="form-control" id="pesan" rows="5" cols="50" placeholder="Masukkan Pesan Anda"></textarea>
                                            </div>
