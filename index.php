...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    ...
                    <div class="form-inline my-2 my-lg-0">
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0 nav-tabs">
                            ...
                            <li class="nav-item">
                                <a data-toggle="tab" href="#tentang">TENTANG KAMI</a>
                            </li>
                            <li class="nav-item">
                                <a data-toggle="tab" href="#layanan">LAYANAN</a>
                            </li>
                            <li class="nav-item">
                                <a data-toggle="tab" href="#kontak">KONTAK KAMI</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="tab-content">
        ...
        <div id="tentang" class="tab-pane fade">
            <section class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
            ...
            <section class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            <h2 style="text-align: center;">Produk Kami</h2>
                            <p style="text-align:center;">Bagi kami pelayanan kepada anda adalah hal utama, oleh karena itu kami memiliki beberapa layanan bagi anda seperti</p>
                            <div class="row">
                                <div class="col-md-4">
